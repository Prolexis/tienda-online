...
import type { AuthRequest, RegisterDTO, LoginDTO } from '../types';
...
export async function register(
  ...
  try {
    const datos = RegisterSchema.parse(req.body) as RegisterDTO;
...
export async function login(
  ...
  try {
    const datos = LoginSchema.parse(req.body) as LoginDTO;
